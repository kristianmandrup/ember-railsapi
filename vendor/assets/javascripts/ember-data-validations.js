// Last commit: f48febd (2013-02-15 04:39:59 -0500)


(function() {
DS.Validations = Ember.Namespace.create({
  VERSION: '0.0.1'
});
...
(function() {
DS.Validations.patterns = Ember.Namespace.create({
...
DS.Validations.validators.local.reopen({
  exclusion: function(model, property, options) {
    ...
    if (options.message === undefined) {
      options.message = DS.Validations.messages.render('exclusion', options);
    }
  ...
  length: function(model, property, options) {
    ...
    for (index = 0; index < keys.length; index++) {
      ...
      if (options[key] !== undefined && options.messages[key] === undefined) {
        ...
        options.messages[key] = DS.Validations.messages.render(MESSAGES[key], options);
